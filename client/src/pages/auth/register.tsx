          ...
          >
            <div className="relative">
              ...
              <Input
                ...
                className={cn(
                  "border-none bg-[#1e1f22] pl-7 text-white placeholder:text-[#4e5058] focus-visible:ring-2 focus-visible:ring-[#5865f2]",
          ...
          <Field label="Password" required error={errors.password?.message}>
            <div className="relative">
              <Input
                ...
                className={cn(
                  "border-none bg-[#1e1f22] pr-10 text-white placeholder:text-[#4e5058] focus-visible:ring-2 focus-visible:ring-[#5865f2]",
